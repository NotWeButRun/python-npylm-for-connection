...
BOOST_PYTHON_MODULE(npylm)
{
    ...
    boost::python::class_<Model>("model", boost::python::init<Dataset*, int>())
        ...
        .def("set_hpylm_beta_hypers", &Model::set_hpylm_beta_hypers)
        .def("set_hpylm_gamma_hypers", &Model::set_hpylm_gamma_hypers)
        .def("set_vpylm_beta_hypers", &Model::set_vpylm_beta_hypers)
        .def("set_vpylm_gamma_hypers", &Model::set_vpylm_gamma_hypers)
        .def("set_vpylm_orderbeta_hypers", &Model::set_vpylm_orderbeta_hypers)
        .def("set_vpylm_poisson_hypers", &Model::set_vpylm_poisson_hypers)
